...
import ai.openclaw.app.protocol.OpenClawAudioCommand
...
class InvokeDispatcher(
  ...
  suspend fun handleInvoke(command: String, paramsJson: String?): GatewaySession.InvokeResult {
    ...
    return when (command) {
      ...
      OpenClawCameraCommand.Stream.rawValue -> cameraHandler.handleStream(paramsJson)
      ...
      // Audio command
      OpenClawAudioCommand.Record.rawValue -> audioHandler.handleRecord(paramsJson)
